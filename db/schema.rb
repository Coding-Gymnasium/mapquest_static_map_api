...
ActiveRecord::Schema.define(version: 2021_03_09_191301) do
  ...
  create_table "transfers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cohort_id"], name: "index_transfers_on_cohort_id"
    t.index ["school_id"], name: "index_transfers_on_school_id"
  ...
  add_foreign_key "transfers", "cohorts"
  add_foreign_key "transfers", "schools"
